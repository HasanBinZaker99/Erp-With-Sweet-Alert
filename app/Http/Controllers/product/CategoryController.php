...
class CategoryController extends Controller
{
    ...
    function addCategory(Request $req){
        ...
        $user->note = $req->note;
        $user->save();
        return redirect('categoryList')->with('Create_Message','New Category Created Successfully');
    }
    function show($id){
    ...
    function delete(Request $request){
        ...
        return redirect('categoryList')->with('Delete_Message','Category deleted Successfully');
    }
    function update(Request $req){
        ...
        $data->note = $req->note;
        $data->save();
        return redirect('categoryList')->with('Update_Message','Category Updated Successfully');
    }
