...
public function addScatetory(Request $req){
    ...
    $user->note = $req->note;
    $user->save();
    return redirect('s-categorylist')->with('Create_Message','New Sub Category Created Successfully');
}
public function showuptbl(Request $req){
    ...
    function Sdelete(Request $request){
        ...
        return redirect('s-categorylist')->with('Delete_Message','Sub Category deleted Successfully');
    }
    function Supdate(Request $req){
        ...
        $data->note = $req->note;
        $data->save();
        return redirect('s-categorylist')->with('Update_Message','Sub Category Updated Successfully');
    }
