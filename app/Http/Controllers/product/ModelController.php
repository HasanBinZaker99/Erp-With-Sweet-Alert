...
class ModelController extends Controller
{
    ...
    public function addmodel(Request $req){
        ...
        $user->note = $req->note;
        $user->save();
        return redirect('model-list')->with('Create_Message',' New Model Created Successfully');
    }
    ...
    function mdelete(Request $request){
        ...
        return redirect('model-list')->with('Delete_Message', 'Model Deleted Successfully');
    }
    ...
    function Mupdate(Request $req){
        ...
        $data->note = $req->note;
        $data->save();
        return redirect('model-list')->with('Update_Message', ' Model Updated Successfully');
    }
