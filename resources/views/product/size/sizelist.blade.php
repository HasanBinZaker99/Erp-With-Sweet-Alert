...
{{--                <h4 class="text-success">{{ Session::get('message') }}</h4>--}}
                <div class="card bg-white">
                    <h4 class="card-header">All Sizes</h4>
                            ...
                            <form action="/size-search" method="GET">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 ml-0">
                                        <span class="float-right col-md-6"><a href="/add-size" class="btn btn-success float-right">+Add</a></span>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                @foreach ($sizes as $size)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/sz-edit/{{$size->id}}" class="btn btn-success btn-sm" title="Update">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a  class="btn btn-danger btn-sm" id="delete" title="Delete" href="javascript:void(0)" data-url="{{ route('SizeInfo', $size->id) }}" >
    ...
    <script>
        function create()
        {
            ...
            Toast.fire({
                icon: 'success',
                title: 'New Size Created Successfully'
            })
        }
        function wise_words()
        {
