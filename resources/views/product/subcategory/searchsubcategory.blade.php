                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                @foreach ($searchs as $search)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$search->subCategoryName}}</td>
                                        <td>{{$search->subCategoryCode}}</td>
                                        <td>{{$search->note}}</td>

                                        <td>
                                            <a href="/s-edit/{{$search->id}}" class="btn btn-success btn-sm" title="Update">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a  class="btn btn-danger btn-sm" id="delete" title="Delete" href="javascript:void(0)" data-url="{{ route('subCategoryInfo', $search->id) }}" >
