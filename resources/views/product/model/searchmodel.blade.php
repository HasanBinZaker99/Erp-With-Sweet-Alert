                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                @foreach ($searchs as $search)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/m-edit/{{$search->id}}" title="Update" class="btn btn-success btn-sm">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a  class="btn btn-danger btn-sm" id="delete" title="Delete" href="javascript:void(0)" data-url="{{ route('ModelInfo', $search->id) }}" >
