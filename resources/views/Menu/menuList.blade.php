                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            @foreach ($menu as $menus)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/menu-edit/{{$menus->id}}" class="btn btn-success btn-sm">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        <a class="btn btn-danger btn-sm" id="delete" href="javascript:void(0)" data-url="{{ route('menuInfo', $menus->id) }}">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('deleteMenu')}}" class="form-group" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
