        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if(auth()->user()->roleId=== 1)
                    ...
                    <li class="nav-item {{(request()->is('add-project-category')) || (request()->is('new-project-category'))|| (request()->is('all-Project-Categories')) || request()->is('add-purchase') || request()->is('add-project-category') ? 'manu-is-opening menu-open active':''}}">
                        ...
                        <ul class="nav nav-treeview {{(request()->is('add-project-category')) || (request()->is('new-project-category')) || (request()->is ('all-Project-Categories')) ? 'navAll':''}}">
                            ...
                            <li class="nav-item">
                                <a href="/add-purchase" class="nav-link ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> New Purchase</p>
                                </a>
                            </li>
...
{{--                            </li>--}}
                    ...
                    <li class="nav-item {{request()->is('categoryList')|| (request()->is('s-categorylist'))|| (request()->is('unit-list')) || request()->is('brand-list') || request()->is('model-list')|| request()->is('model-list') || request()->is('size-list') || request()->is('color-list') || request()->is('add-product') || request()->is('product-list')  ? 'menu-is-opening menu-open active':''}}">
                        <a href="#" class="nav-link {{ request()->is('categoryList') || (request()->is('s-categorylist'))|| (request()->is('unit-list')) || request()->is('brand-list') || request()->is('model-list')|| request()->is('model-list') || request()->is('size-list') || request()->is('color-list') || request()->is('/add-product') || request()->is('product-list')  ? 'active':''}}">
                            <!-- <i class="nav-icon fas fa-copy"></i> -->
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/categoryList" class="nav-link {{ request()->is('categoryList')?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Category</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/s-categorylist" class="nav-link {{ request()->is('s-categorylist') ?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Sub Category</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/unit-list" class="nav-link {{ request()->is('unit-list') ?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Units</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/brand-list" class="nav-link {{ request()->is('brand-list') ?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Brands</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/model-list" class="nav-link {{ request()->is('model-list')?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Model</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/size-list" class="nav-link {{ request()->is('size-list')?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Size</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/color-list" class="nav-link {{ request()->is('color-list')?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Color</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/add-product" class="nav-link {{ request()->is('add-product')?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Add Products</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item {{request()->is('suppGrp-list')|| (request()->is('add-supplier'))|| (request()->is('supplier-list'))  ? 'menu-is-opening menu-open active':''}}">
                        <a href="{{route('all-Project-Categories')}}"class="nav-link {{(request()->is('suppGrp-list')) || (request()->is('add-supplier')) || (request()->is('supplier-list')) ? 'active':''}}">
                            <!-- <i class="nav-icon fas fa-copy"></i> -->
                        ...
                        <ul class="nav nav-treeview " >
                            <li class="nav-item">
                                <a href="/suppGrp-list" class="nav-link {{ (request()->is('suppGrp-list'))?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Supplier Groups</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/add-supplier" class="nav-link {{ request()->is('add-supplier')?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Add Supplier</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/supplier-list" class="nav-link {{ request()->is('supplier-list')?'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Suppliers List</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item {{(request()->is('allCompanyInfo')) || (request()->is('add-company-info')) ? 'manu-is-opening menu-open active':''}}">
                        <a href="{{ route('allCompanyInfo')}}" class="nav-link {{(request()->is('allCompanyInfo')) || (request()->is('add-company-info')) ? 'active':''}}" data-toggle="collapse">
                            <!-- <i class="nav-icon fas fa-copy"></i> -->
                        ...
                        <ul class="nav nav-treeview collapsible-body {{(request()->is('allCompanyInfo'))||(request()->is('add-company-info')) ? 'navAll':''}}" >
