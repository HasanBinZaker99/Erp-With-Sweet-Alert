    ...
    <ul class="navbar-nav ml-auto">
            ...
            <p class="show">
                <script type="text/javascript">
                    window.onload = function() {
                        document.getElementById(".showcode").innerHTML = create();
                    }
                </script>
            </p>
        </li> -->
        ...
        <li>
            <p class="show">
                <script type="text/javascript">
                    window.onload = function() {
                        document.getElementById(".showcode").innerHTML = StatusMessage();
                    }
                </script>
            </p>
        </li>
        ...
        <li>
            <p class="show">
                <script type="text/javascript">
                    window.onload = function() {
                        document.getElementById(".showcode").innerHTML = update('update');
                    }
                </script>
            </p>
        </li>
        ...
        <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item text-primary" href="{{ route('updateAdminDetails') }}">
        ...
        {{-- <a class="dropdown-item text-primary" href="{{ route('logout') }}" onclick="event.preventDefault();--}}
        {{-- document.getElementById('logout-form').submit();">--}}
        {{-- <span class="me-2"> Update Profile </span><i class="fa-solid fa-address-card" style="color:#ffc107"></i>--}}
        {{-- </a>--}}
        {{-- <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">--}}
        {{-- @csrf--}}
        {{-- </form>--}}
        ...
        {{-- <a class="dropdown-item text-primary" href="{{ route('logout') }}" onclick="event.preventDefault();--}}
        {{-- document.getElementById('logout-form').submit();">--}}
        {{-- <span class="me-2"> Change Password  </span><i class="fa-solid fa-key" style="color:#ffc107"></i>--}}
        {{-- </a>--}}
