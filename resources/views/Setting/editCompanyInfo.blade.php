            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <div class="card">
                            <div class="card-header">Add Company Information</div>
                            <div class="card-body">
                                ...
                                <form action="{{route('updateCompanyInfo',['id'=>$companyInfo['id']])}}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="file" class="form-control" name="logo"  value="{{ $companyInfo->logo }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Fav Icon</label>
                                        <div class="col-md-9">
                                            <input type="file" class="form-control" name="favIcon" value="{{ $companyInfo->favicon }}"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 input-group search_select_box">
                                            ...
                                            <select id="state" class="form-control select2 bg-white" name="state" data-live-search="true">
                                                <option selected>{{$companyInfo->state}}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 input-group search_select_box">
                                            ...
                                            <select id="country" class="form-control select2 bg-white" name="country" data-live-search="true">
                                                <option selected>{{$companyInfo->country}}</option>
